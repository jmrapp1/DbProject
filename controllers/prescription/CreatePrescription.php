...
if (isset($_POST['refillsLeft']) && isset($_POST['customerId']) && isset($_POST['medId'])) {
    $date = date("Y-m-d H:i:s");
    $refillsLeft = $_POST['refillsLeft'];
    $customerId = $_POST['customerId'];
    $medId = $_POST['medId'];

    $res = PrescriptionService::Instance()->createPrescription($date, $refillsLeft, $customerId, $medId);
